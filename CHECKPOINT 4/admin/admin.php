                    ...
                    <section>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center font-weight-bold mb-4">Tour Packages</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3 mx-auto">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mt-1 font-weight-bold"><a href="#!">pack 1</a><a><span class="badge badge-warning float-right">action</span></a></h6>
                                        ...
                                        <div class="media">
                                            <img class="d-flex mr-3" src="https://mdbootstrap.com/img/Photos/Others/placeholder1.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h6 class="mt-1 font-weight-bold"><a href="#!">pack 2</a><a><span class="badge badge-warning float-right">EDIT</span></a></h6>
                                                <p class="text-muted">sample text.....</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="media">
                                            <img class="d-flex mr-3" src="https://mdbootstrap.com/img/Photos/Others/placeholder1.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h6 class="mt-1 font-weight-bold"><a href="#!">pack 3</a><a><span class="badge badge-warning float-right">EDIT</span></a></h6>
                                                <p class="text-muted">sample text.....</p>
                                            </div>
                                        </div>
                                        <hr>
